...
public class NuevoCliente extends javax.swing.JFrame {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        if (!Nombre.getText().equals("") && !Apellido.getText().equals("") && !Cedula.getText().equals("")) {
            Agregar_Nodo newWin = new Agregar_Nodo(this.data, Nombre.getText(), Apellido.getText(), Cedula.getText());
            newWin.setVisible(true);
            this.dispose();
        } else {
            JOptionPane.showMessageDialog(null, "Error, debe completar todos los campos antes de agregar su dirección.");
        }
